      ...
      <section className="min-h-screen flex flex-col justify-center items-center px-6 py-16 text-center">
        ...
        >
          <button
            ...
            className="px-10 py-5 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-full text-lg font-semibold shadow-lg shadow-cyan-500/30 transition-all duration-300 hover:scale-[1.03]"
          >
            Get Started
          </button>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            <div className="relative z-10">
              <div className="bg-gradient-to-r from-cyan-900/30 to-purple-900/30 rounded-3xl p-8 backdrop-blur-md border border-cyan-500/20">
            ...
            <div className="absolute -bottom-12 right-0 md:right-12 w-64 md:w-80 transform rotate-6 shadow-2xl">
              <div className="bg-gradient-to-b from-slate-800 to-slate-950 rounded-3xl p-4 border border-slate-600">
                <div className="aspect-[9/19] bg-black rounded-2xl overflow-hidden">
                  <div className="w-full h-full bg-gradient-to-br from-blue-950 to-purple-950 flex items-center justify-center">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            {[
              ...
              >
                <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-cyan-300 to-purple-400 bg-clip-text text-transparent mb-2">
                  {stat.value}
                </div>
